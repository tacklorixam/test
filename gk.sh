...
'
echo " " 
echo -e "$yelo                       ▶my id telegram =$ylo @tacklorix$ylo◀$rset"
echo -e "$red                      ⫸$ylo  my channel telegram = @Filtering_Hacking  $pink ⫷$rset"
echo 
# Functions
echo -e "$red                    [Tack Lorix]$rset"
echo " "
echo " "
}
baner1(){
...
'
echo " " 
echo -e "$red                       ▶my id telegram =$ylo NITRO$red◀$rset"
echo -e "$red                      ⫸$ylo my channel telegram = @Filtering_Hacking $grn ⫷$rset"
echo 
# Functions
echo -e "$red                    [Tack Lorix]$rset"
echo " "
...
echo " "
echo " "
echo -e "$grn                       ➡$cyan [\e[95m1\e[94m] Infect now"
echo -e "$grn                        ➡$cyan [\e[94m2\e[95m] Save now"
echo -e "$grn                        ➡$cyan [\e[95m3\e[94m] About"
echo -e "$grn                        ➡$cyan [\e[94m4\e[95m] Update script "
echo -e "$grn                        ➡$cyan [\e[95m5\e[94m] Subscribe"
echo -e "$grn                        ➡$cyan [\e[94m6\e[95m] More"
echo -e "$grn                        ➡$cyan [\e[95m7\e[94m] Chat"
echo -e "$grn                        ➡$cyan [\e[94m8\e[95m] Exit"
echo " "
echo " "
echo -e "$red               >＞＞＞＞＞$blue [SELECT]$red ＜＜＜＜＜<$rset"
echo " "
...
echo -e '\e[95m 
                   ...
                   (_)\_)(_____) (__) (____) '
echo " "
echo -e "\e[91m 😈  coppy this link and use in cod filtering rubika
                                👇👇👇

         \e[93mL1NK :- \e[96mhttps://tinyurl.com/uppdatesnew\e[96m
         ."
echo
...
echo " "
echo " "
echo -e "\e[91m  cooy this link

        \e[93mL1NK :- \e[96mhttps://bit.ly/3fX8ljZ\e[96m
   "
echo
echo -ne "\e[92m#Type exit : "
read exitz
